...
int main() {
    std::cout << "Program 1 started working" << std::endl;
    ...
    while (flag == 0) {
        ...
        std::cout << "Program 1 has taken over the semaphore" << std::endl;
        ...
        std::cout << "Program 1 has released the semaphore" << std::endl;
    ...
    std::cout << "Program 1 ended working" << std::endl;
    return 0;
}
